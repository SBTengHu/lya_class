...
N_epochs =40
version =f'spec{len(flux_lya.flatten())}_{}_allM_E{N_epochs:d}_v1'
...
ax2.plot(wavelength_all, test_LOS_MASK[0:5].flatten(), linestyle='--',color = 'blue',alpha =0.5,label='true label')
